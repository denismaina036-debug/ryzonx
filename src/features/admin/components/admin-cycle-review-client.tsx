  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <p className="text-xs font-semibold uppercase tracking-widest text-royal-600">Investment Cycle Oversight</p>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <section className="rounded-xl border border-border bg-card p-5">
          <h3 className="font-semibold text-navy-900">Operational Controls</h3>
          <p className="mt-1 text-xs text-navy-500">Cycles do not require admin approval. Controls here are for operational recovery and oversight.</p>
          <Textarea
