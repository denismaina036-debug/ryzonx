...
export const DEFAULT_LANDING_PAGE_CONTENT: LandingPageContent = {
  ...
  heroStats: [
    { id: "hs1", title: "Total Pool Value", mode: "automatic", automaticKey: "total_pool_value", icon: "TrendingUp" },
    { id: "hs2", title: "Active Investors", mode: "automatic", automaticKey: "active_investors", icon: "Users" },
    { id: "hs3", title: "Today's ROI", mode: "automatic", automaticKey: "daily_roi", icon: "BarChart3", changeType: "positive" },
    { id: "hs4", title: "Monthly ROI", mode: "automatic", automaticKey: "monthly_roi", icon: "Activity", changeType: "positive" },
    { id: "hs5", title: "Win Rate", mode: "automatic", automaticKey: "win_rate", icon: "Target" },
    { id: "hs6", title: "Closed Trades", mode: "automatic", automaticKey: "closed_trades", icon: "BarChart3" },
  ],
  statistics: [
    { id: "s1", title: "Total Investors", mode: "automatic", automaticKey: "total_investors", icon: "Users" },
    { id: "s2", title: "Average Investment", mode: "automatic", automaticKey: "average_investment", icon: "Wallet" },
    { id: "s3", title: "Largest Investment", mode: "automatic", automaticKey: "largest_investment", icon: "Crown" },
    { id: "s4", title: "Average ROI", mode: "automatic", automaticKey: "average_roi", icon: "TrendingUp" },
    { id: "s5", title: "Total Deposits", mode: "automatic", automaticKey: "total_deposits", icon: "ArrowDownToLine" },
    { id: "s6", title: "Total Withdrawals", mode: "automatic", automaticKey: "total_withdrawals", icon: "ArrowUpFromLine" },
  ],
  contact: {
