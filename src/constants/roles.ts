...
export const PERMISSIONS = {
  ...
  MANAGE_USERS: [USER_ROLES.ADMINISTRATOR],
  VIEW_ALL_USER_DATA: [USER_ROLES.ADMINISTRATOR],
  ...
  MANAGE_PLATFORM_CONFIG: [USER_ROLES.ADMINISTRATOR],
  MANAGE_FINANCIAL_SETTINGS: [USER_ROLES.ADMINISTRATOR],
  VIEW_AUDIT_LOGS: [USER_ROLES.ADMINISTRATOR],
  REVIEW_POOL_MANAGER_APPLICATIONS: [USER_ROLES.ADMINISTRATOR],
  APPROVE_POOLS: [USER_ROLES.ADMINISTRATOR],
  APPROVE_STRATEGIES: [USER_ROLES.ADMINISTRATOR],
  REJECT_POOLS: [USER_ROLES.ADMINISTRATOR],
  REJECT_STRATEGIES: [USER_ROLES.ADMINISTRATOR],
  SUSPEND_POOLS: [USER_ROLES.ADMINISTRATOR],
  SUSPEND_STRATEGIES: [USER_ROLES.ADMINISTRATOR],
  MODERATE_REVIEWS: [USER_ROLES.ADMINISTRATOR],

  // Pool Manager — own business
  CREATE_STRATEGY: [USER_ROLES.POOL_MANAGER, USER_ROLES.ADMINISTRATOR],
  EDIT_OWN_STRATEGY: [USER_ROLES.POOL_MANAGER, USER_ROLES.ADMINISTRATOR],
  SUBMIT_STRATEGY: [USER_ROLES.POOL_MANAGER, USER_ROLES.ADMINISTRATOR],
  CREATE_POOL: [USER_ROLES.POOL_MANAGER, USER_ROLES.ADMINISTRATOR],
  EDIT_OWN_POOL_DRAFT: [USER_ROLES.POOL_MANAGER, USER_ROLES.ADMINISTRATOR],
  SUBMIT_POOL: [USER_ROLES.POOL_MANAGER, USER_ROLES.ADMINISTRATOR],
  MANAGE_OWN_CYCLES: [USER_ROLES.POOL_MANAGER, USER_ROLES.ADMINISTRATOR],
  MANAGE_OWN_SETTLEMENTS: [USER_ROLES.POOL_MANAGER, USER_ROLES.ADMINISTRATOR],
  MANAGE_OWN_JOURNAL: [USER_ROLES.POOL_MANAGER, USER_ROLES.ADMINISTRATOR],

  // Investor — social + profile
  FOLLOW_POOL_MANAGER: [
    USER_ROLES.INVESTOR,
    USER_ROLES.POOL_MANAGER_APPLICANT,
    USER_ROLES.POOL_MANAGER,
