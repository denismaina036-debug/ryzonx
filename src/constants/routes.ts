...
export const ROUTES = {
  ...
  adminFinanceCorrections: "/admin/finance/corrections",
  ...
  adminPoolManagersAdmissionSettings: "/admin/pool-managers/admission-settings",
  ...
  adminCommunicationMessages: "/admin/communication/messages",
  adminCommunicationNotifications: "/admin/communication/notifications",
...
export const ADMIN_ROUTES: RoutePath[] = [
  ...
  ROUTES.adminPoolManagersAdmissionSettings,
  ...
  ROUTES.adminCommunicationMessages,
  ROUTES.adminCommunicationCampaigns,
  ROUTES.adminCommunicationNotifications,
