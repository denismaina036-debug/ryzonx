...
export function getMockInvestorDashboardData(
  ...
  const recentActivity: InvestorPoolActivityItem[] = [
    ...
    },
    {
      id: "a-2",
      title: "Withdrawal",
      subtitle: "RyvonX Funding Wallet",
      amount: 1200,
      amountPrefix: "-",
    ...
    },
    {
      ...
      subtitle: "Liquidity Hunter Pool",
      amount: 3200,
      amountPrefix: "+",
